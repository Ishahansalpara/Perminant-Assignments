...
function GreetingCard() {
  ...
  const greetingMessages = {
    guest: "Hello! Welcome to Perminant",
    returning: "Welcome back to Perminant!",
    admin: "Admin access granted",
  };

  const timeMessages = {
    morning: "Have a great morning!",
    afternoon: "Have a great afternoon!",
    evening: "Have a great evening!",
  };
  ...
  return (
    <div style={cardStyle}>
      <h1 style={text}>{greetingMessages[userRole]}</h1>
      <h2 style={text2}>{timeMessages[timeOfDay]}</h2>
      <div style={selectorContainerStyle}>
        <select value={userRole} onChange={(e) => setUserRole(e.target.value)} style={selectStyle}>
          <option value="returning">Returning</option>
          <option value="admin">Admin</option>
